  ...
  return (
    <footer className="bg-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 max-w-xs">
              Capturing life's precious moments with artistic excellence and professional precision.
            </p>
          </div>
        ...
        >
          <p>&copy; {new Date().getFullYear()} Aperture Photography. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
